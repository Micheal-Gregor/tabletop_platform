...
| A2 deck + draw + the reading board (I-67) | 8c5da32 + closures aaaf52d/a4740f7 | RETURN (D1–D6) → closed → RETURN (D7 flaky falsifier, false record) → superseded + deterministic re-kill → PASS · k7-pass-a2-deck | awaiting owner playtest |
