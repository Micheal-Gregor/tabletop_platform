...
| I-33 | F5 state regions: seats[].role · crew[] · ventures[] · debts[] · receivables[] · timedEffects[] · ledger{loaded, entries[]} · results. The WOVEN pass intent is 'turn:end' (library tier); kernel 'turn:pass' remains the primitive (registerIntent refuses dup — supersede-never-respec) | benign | local (library/*) |
